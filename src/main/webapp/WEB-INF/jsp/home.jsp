		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="list-group">
					<a href="#" class="list-group-item"> <span class="ok badge">przed chwilą </span> <i class="glyphicon glyphicon-user"></i> Cristiano Ronaldo dołączył do: Orlik SP9 13.11.2014 18:00 - 20:00
